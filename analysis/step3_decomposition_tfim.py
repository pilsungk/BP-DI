...
#
# Outputs:
#   bridge_decomposition_summary.csv
#   bridge_decomposition_steps.csv
#   m2_f_scaling_fits.csv
#   second_moment_decomposition.pdf
#   f_ratio_vs_n.pdf
# ============================================================
import warnings
...
summary.to_csv("bridge_decomposition_summary.csv",
               index=False)
...
pd.DataFrame(fit_rows).to_csv("m2_f_scaling_fits.csv",
                              index=False)
...
steps.to_csv("bridge_decomposition_steps.csv", index=False)
...
plt.tight_layout()
fig.savefig("second_moment_decomposition.pdf",
            bbox_inches="tight")
plt.show()
...
plt.tight_layout()
fig2.savefig("f_ratio_vs_n.pdf", bbox_inches="tight")
plt.show()
